...
{
  "$end", "error", "$undefined", "INTEGER", "CHARACTER", "'\\n'",
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 34 "YaccCode.y" /* yacc.c:1646  */
    {
...
#line 1278 "y.tab.c" /* yacc.c:1646  */
  ...
  case 5:
#line 89 "YaccCode.y" /* yacc.c:1646  */
    {ch1=(yyvsp[-4].character);ch2=(yyvsp[-3].number);ch3=(yyvsp[-2].number);ch4=(yyvsp[-1].number),ch5=(yyvsp[0].number);}
#line 1284 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 90 "YaccCode.y" /* yacc.c:1646  */
    {ch6=(yyvsp[-5].character);ch7=(yyvsp[-4].character);ch8=(yyvsp[-3].number);ch9=(yyvsp[-2].number),ch10=(yyvsp[-1].number),ch11=(yyvsp[0].number);
	                                                            if(ch6 == 's')
                                                                {
                                                                    dc_node.status = 1;
                                                                    dc_node.dc_type = ch7;
...
#line 106 "YaccCode.y" /* yacc.c:1906  */
